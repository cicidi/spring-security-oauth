...
export class HomeComponent {
    ...
    login() {
        ...
        window.location.href = 'http://localhost:8083/auth/realms/electroknox-dev/protocol/openid-connect/auth?response_type=code&&scope=openid%20write%20read&client_id=' +
